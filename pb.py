...
@app.route('/ques1')
def ques1():
    return render_template('/text/generalQues/option-type/residentSgp.html')

@app.route('/ques1', methods=['POST'])
def post_ques1():
    ans1 = request.form['test1']
...
@app.route('/ques3')
def ques3():
    return render_template('/text/QuesAboutNTU/rating-type/rateNTU.html')

@app.route('/ques3', methods=['POST'])
def post_ques3():
    ans3 = request.form['rangeInput']
    print (ans3)
